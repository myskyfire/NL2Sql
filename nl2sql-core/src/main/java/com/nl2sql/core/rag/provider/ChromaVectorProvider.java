    ...
    public List<VectorSearchResult> searchSimilar(String question, int maxResults, double minScore) {
        ...
        try {
            ...
            for (EmbeddingMatch<TextSegment> match : matches) {
                ...
                Object qualityScoreObj = metadata.toMap().get("quality_score");
                if (qualityScoreObj instanceof Number) {
                    result.setQualityScore(((Number) qualityScoreObj).floatValue());
                } else if (qualityScoreObj instanceof String) {
                    result.setQualityScore(Float.parseFloat((String) qualityScoreObj));
                } else {
